   ...
   <script src="<?php echo ('assets/admin/') ?>vendor/datatables/jquery.dataTables.js"></script>
   <script src="<?php echo ('assets/admin/') ?>vendor/datatables/dataTables.bootstrap4.js"></script>

   <!-- Custom scripts for all pages-->
   <script src="<?php echo ('assets/admin/') ?>js/sb-admin.min.js"></script>

   <!-- Demo scripts for this page-->
   <script src="<?php echo ('assets/admin/') ?>js/demo/datatables-demo.js"></script>
